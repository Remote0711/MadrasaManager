...
var sidebarItems = [
    ...
    {
        name: tr_1.tr.progress,
        href: '/dashboard/parent/progress',
        icon: lucide_react_1.TrendingUp,
    },
    {
        name: tr_1.tr.attendance,
