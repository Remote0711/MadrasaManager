...
import { TrendingUp, CheckSquare, Menu, Home, ChevronLeft, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6 justify-between">
        <Link href="/dashboard/parent" className="flex items-center gap-2 font-semibold min-w-0">
...
export default function ParentSidebar({ className, isCollapsed, onToggleCollapse }: ParentSidebarProps) {
