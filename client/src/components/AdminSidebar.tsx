...
import { Users, GraduationCap, BookOpen, Calendar, Menu, Home, ChevronLeft, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6 justify-between">
        <Link href="/dashboard/admin" className="flex items-center gap-2 font-semibold min-w-0">
...
export default function AdminSidebar({ className, isCollapsed, onToggleCollapse }: AdminSidebarProps) {
