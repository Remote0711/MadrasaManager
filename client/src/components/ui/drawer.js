...
var DrawerOverlay = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(vaul_1.Drawer.Overlay, __assign({ ref: ref, className: (0, utils_1.cn)("fixed inset-0 z-50 bg-black/80", className) }, props)));
});
...
var DrawerContent = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(DrawerPortal, { children: [(0, jsx_runtime_1.jsx)(DrawerOverlay, {}), (0, jsx_runtime_1.jsxs)(vaul_1.Drawer.Content, __assign({ ref: ref, className: (0, utils_1.cn)("fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border bg-background", className) }, props, { children: [(0, jsx_runtime_1.jsx)("div", { className: "mx-auto mt-4 h-2 w-[100px] rounded-full bg-muted" }), children] }))] }));
});
exports.DrawerContent = DrawerContent;
DrawerContent.displayName = "DrawerContent";
var DrawerHeader = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)("div", __assign({ className: (0, utils_1.cn)("grid gap-1.5 p-4 text-center sm:text-left", className) }, props)));
};
