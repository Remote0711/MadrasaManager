...
var Sidebar = React.forwardRef(function (_a, ref) {
    ...
    if (isMobile) {
        return ((0, jsx_runtime_1.jsx)(sheet_1.Sheet, __assign({ open: openMobile, onOpenChange: setOpenMobile }, props, { children: (0, jsx_runtime_1.jsxs)(sheet_1.SheetContent, { "data-sidebar": "sidebar", "data-mobile": "true", className: "w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden", style: {
...
var SidebarGroupLabel = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Comp, __assign({ ref: ref, "data-sidebar": "group-label", className: (0, utils_1.cn)("flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0", "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0", className) }, props)));
});
